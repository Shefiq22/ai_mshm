          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              _HyperalgesiaCard(
                ...
                onMuscleChanged: (v) =>
                    setState(() => _musclePressurePain = v),
                onTendernessChanged: (v) =>
                    setState(() => _bodyTenderness = v),
              ),
...
class _EveningCheckinState extends State<EveningCheckinScreen> {
  ...
  // ── GAGS acne regions (0–4 each) ─────────────────────────────────────────
  double _acneForehead = 0;
  double _acneRightCheek = 0;
  double _acneLeftCheek = 0;
  double _acneNose = 0;
  double _acneChin = 0;
  double _acneChestBack = 0;

  // GAGS = (forehead×2)+(rightCheek×2)+(leftCheek×2)+(nose×1)+(chin×1)+(chestBack×3)
  int get _gagsScore =>
      (_acneForehead * 2 +
              _acneRightCheek * 2 +
              _acneLeftCheek * 2 +
  ...
  String get _gagsSeverity {
    if (_gagsScore == 0) return 'None';
    if (_gagsScore <= 18) return 'Mild';
    if (_gagsScore <= 30) return 'Moderate';
    if (_gagsScore <= 38) return 'Severe';
    return 'Very Severe';
  }

  Color get _gagsColor {
    if (_gagsScore == 0) return AppColors.textLight;
    if (_gagsScore <= 18) return AppColors.riskLow;
    if (_gagsScore <= 30) return AppColors.warningAmber;
    return AppColors.riskHigh;
  }
  ...
  String _acneLabel(double v) {
    switch (v.round()) {
      ...
      case 1: return 'Blackheads / whiteheads only';
      case 2: return 'Small red bumps';
      case 3: return 'Pus-filled bumps';
      case 4: return 'Large painful lumps';
      default: return 'No spots';
    }
  }
  ...
  Widget _acneAreaSlider(
    ...
    final color = _scoreColor(value, max: 4);
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Row(children: [
          Container(
      ...
      SliderTheme(
        ...
        child: Slider(
            value: value, min: 0, max: 4, divisions: 4, onChanged: onChanged),
      ),
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text('No spots', style: AppTextStyles.smallText),
        Text('Large lumps', style: AppTextStyles.smallText),
      ]),
    ]);
  }
        ...
        Expanded(
          child: SingleChildScrollView(
            ...
            child: Column(
                    ...
                    Row(children: [
                      Expanded(
                          child: _toggleButton(
                              ...
                              () => setState(() => _mastalgiaQuality = 'Sharp'))),
                      const SizedBox(width: 8),
                      Expanded(
                          child: _toggleButton(
                              'Dull',
              ...
              _sectionCard(
                title: 'Acne Severity',
                subtitle: 'For each area, pick what best describes what you see.',
                children: [
                  const _GagsRegionLabel(label: 'FACE'),
                  const SizedBox(height: 10),
                  _acneAreaSlider('Forehead', _acneForehead,
                      (v) => setState(() => _acneForehead = v)),
                  const SizedBox(height: 16),
                  _acneAreaSlider('Right Cheek', _acneRightCheek,
                      (v) => setState(() => _acneRightCheek = v)),
                  const SizedBox(height: 16),
                  _acneAreaSlider('Left Cheek', _acneLeftCheek,
                      (v) => setState(() => _acneLeftCheek = v)),
                  const SizedBox(height: 16),
                  _acneAreaSlider('Nose', _acneNose,
                      (v) => setState(() => _acneNose = v)),
                  const SizedBox(height: 16),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _gagsColor.withOpacity(0.06),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(color: _gagsColor.withOpacity(0.2)),
                    ),
                    child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                      ...
                      Row(children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: _gagsColor.withOpacity(0.12),
                            borderRadius: BorderRadius.circular(20),
                          ),
                          child: Text(_gagsSeverity,
                              style: TextStyle(
                                  fontSize: 13,
                                  fontWeight: FontWeight.w700,
                                  color: _gagsColor)),
              ...
              Container(
                ...
                child: Column(
                  ...
                  const Text(
                    'Enter abdominal circumference change in cm. Leave blank if not measured.',
                    ...
                    child: Column(
                      ...
                      Row(children: [
                        ...
                        Container(
                          ...
                          child: const Text('unusual_bleed_rate',
                              style: TextStyle(
                                  fontSize: 9,
                                  fontWeight: FontWeight.w600,
                                  color: AppColors.primary)),
                      ...
                      const SizedBox(height: 4),
                      const Text(
                        'Any bleeding outside your period window today? '
                        'Flag it in Period Tracking — it feeds the '
                        'anovulatory_rate variable in the PCOS model.',
                        style: TextStyle(
            ...
            child: Column(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(20)),
                child: _done ? _CompleteView(scale: _tickScale) : _CameraView(),
              ),
              const SizedBox(height: 20),
              Text(
                ...
                child: Row(
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      SizedBox(height: 4),
                      Text(
                        'This session also captures skin temperature variation '
                        'for BBT monophasic pattern detection — replacing the '
                        'lab PRG test for anovulation screening '
                        '(CycleWithPeakorNot → anovulatory_rate).',
                        style: TextStyle(
                            fontSize: 12, color: AppColors.textMedium),
                      ),
                      SizedBox(height: 6),
                      Text('Source: Camera / Wearable sensor',
                          style: TextStyle(
                              fontSize: 10,
                              fontWeight: FontWeight.w600,
...
// ── GAGS region section label ─────────────────────────────────────────────────
class _GagsRegionLabel extends StatelessWidget {
  final String label;
  const _GagsRegionLabel({required this.label});
...
class _SummaryItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(children: [
        Text('$label  ',
            style:
                AppTextStyles.cardSubtitle.copyWith(color: AppColors.textDark)),
        RichText(
            text: TextSpan(children: [
          TextSpan(
              text: '${value.round()}',
